          ...
          <div className="flex flex-wrap gap-2">
            <div className="flex items-center space-x-2">
              ...
              <div className="flex space-x-1">
                <Button
                  variant={
                    selectedLevels.includes("info") ? "default" : "outline"
                  }
                  size="sm"
                  onClick={() => handleLevelChange("info")}
                  className={
                    selectedLevels.includes("info") ? "bg-blue-600" : ""
                  }
                >
                  信息
                </Button>
                <Button
                  variant={
                    selectedLevels.includes("warn") ? "default" : "outline"
                  }
                  size="sm"
                  onClick={() => handleLevelChange("warn")}
                  className={
                    selectedLevels.includes("warn") ? "bg-amber-600" : ""
                  }
                >
                  警告
                </Button>
                <Button
                  variant={
                    selectedLevels.includes("error") ? "default" : "outline"
                  }
                  size="sm"
                  onClick={() => handleLevelChange("error")}
                  className={
                    selectedLevels.includes("error") ? "bg-red-600" : ""
                  }
                >
                  错误
                </Button>
