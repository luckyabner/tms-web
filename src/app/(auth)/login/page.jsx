...
export default function Login() {
  ...
  return (
    <div className={`transition-all duration-700 ease-out ${animationComplete ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
      <div className="mb-6 flex flex-col items-center justify-center space-y-2 mt-2">
        <div className="relative">
          ...
          <div className="relative flex h-14 w-14 items-center justify-center rounded-full bg-gradient-to-br from-blue-600 to-indigo-700 shadow-xl">
            <UserCircle2 className="h-7 w-7 text-white drop-shadow-md" />
          </div>
        </div>
        <h1 className="text-2xl font-bold tracking-tight bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600 bg-clip-text text-transparent drop-shadow-sm">人才管理系统</h1>
        <div className="h-1 w-10 rounded-full bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600 mt-1"></div>
      </div>
      
      <Card className="w-full max-w-[380px] border-none shadow-2xl backdrop-blur-[12px] bg-white/95 dark:bg-gray-900/80 relative overflow-hidden rounded-xl py-2">
        {/* 装饰元素 */}
        ...
        <CardHeader className="space-y-1 pb-2 pt-2">
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-2">
            {error && (
              <div className="p-2 rounded-lg bg-red-50 text-red-600 text-xs flex items-center gap-2 border border-red-100 shadow-sm animate-pulse">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative group">
                <Input
                  ...
                  className="pl-4 h-10 rounded-lg text-sm transition-all border-gray-200 hover:border-gray-300 focus:border-blue-600 focus:ring-2 focus:ring-blue-600/20 dark:bg-gray-800/50 dark:border-gray-700 dark:focus:border-blue-500"
                  required
                  disabled={isLoading}
                  pattern="^1[3-9]\d{9}$"
                />
        ...
        <CardFooter className="flex flex-col space-y-2 pb-3 pt-1">
